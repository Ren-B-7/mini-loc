/* _DARWIN_C_SOURCE must be defined before any system header on macOS.
   The Makefile sets -D_POSIX_C_SOURCE=200809L globally which suppresses the
   automatic definition of _DARWIN_C_SOURCE in the Apple SDK, hiding
   _SC_NPROCESSORS_ONLN from <unistd.h>. Defining it here (as a superset of
